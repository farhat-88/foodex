  ...
  <div class="container">
    <div class="row bg-light">
      <div class="py-5 wrap-about pb-md-5 ftco-animate">
        ...
        <div class="col-md-8">
         <?php if(!empty($mealsList)); ?>
          <?php echo form_open('/receive/update/'.$mealsList->item_id) ?>
          <div class="form-group">
            <?php echo form_label('Item Name'); ?>
            <?php $item_name = set_value('item_name') == true ? set_value('item_name') : $mealsList->item_name ;?>
          ...
          <div class="form-group">
            ...
            <?php $servings = set_value('servings') == true ? set_value('servings') : $mealsList->servings ;?>
          ...
          <div class="form-group">
            ...
            <?php $pickup_address = set_value('pickup_address') == true ? set_value('pickup_address') : $mealsList->pickup_address ;?>
          ...
          <div class="form-group">
            ...
            <?php $prepared_date = set_value('prepared_date') == true ? set_value('prepared_date') : $mealsList->prepared_date ;?>
          ...
          <div class="form-group">
            ...
            <?php $prepared_time = set_value('prepared_time') == true ? set_value('prepared_time') : $mealsList->prepared_time ;?>
            <input type="time" value="<?php echo $prepared_time ?>" class="form-control prepared_time time" name="prepared_time" placeholder="Select Time">
          ...
          <div class="form-group">
            ...
            <?php $food_expiry_expected = set_value('food_expiry_expected') == true ? set_value('food_expiry_expected') : $mealsList->food_expiry_expected ;?>
          ...
          <div class="form-group">
            ...
            <?php if(!empty($foodTypesList)){ ?>
              ...
              <?php } ?>
            <?php } ?>
            <?php echo form_dropdown('food_type', $options ,'food_type',['class'=>'form-control food_type'],''); ?>
            <small class="text-danger error_food_type"><?php echo isset($validation) ? $validation->getError('food_type') : '' ?></small>
          </div>          
